"""Extended token-injection tests: edge cases, property-like determinism checks,
coverage of TokenPlan properties, and seeded digest invariants.

These complement test_tokens.py and cover paths not hit by the existing 4 tests.
"""
